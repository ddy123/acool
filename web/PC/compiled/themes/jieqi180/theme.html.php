...
<div class="pageCenter">
    <div class="mainNavWrap cf">
        ...
        <!-- 非首页第一条广告 -->
        <a class="topBanner" target="_blank" href="'.$this->_tpl_vars['jieqi_url'].'/info/24.html"><img width="800" height="80" alt="#"  title="" src="/sink/image/cjtssy.png" ></a>
...
<div class="footer">
    <div class="footer_main cf">
        ...
        <div class="foot">
            ...
            <p>
                Copyright&nbsp;&nbsp;&copy;&nbsp;2015&nbsp;juziread.&nbsp;All&nbsp;Rights&nbsp;Reserved
            </p>
            <p>
                作者发布<a href="'.$this->_tpl_vars['jieqi_url'].'" style="margin: 0px;">小说</a>作品时，请遵守国家互联网信息管理办法规定。本站所收录小说作品、社区话题、书库评论均属其个人行为，不代表本站立场。
            </p>
            <p>
                我们拒绝任何色情小说，拒绝任何抄袭复制侵犯版权的小说，一经发现，即作删除!
            </p>
            <p>
                巨子中文网&nbsp;版权所有 浙ICP备17059697号-1
            </p>
        </div>
