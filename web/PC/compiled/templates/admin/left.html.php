...
echo '
	...
	<!--burn 添加 2016-12-26-->
	<div id="mu_app" name="mu_app" class="lmenu hd">
		<div class="lmenu_title in" onClick="showsubmenu(\'sm_database\')">
			APP后台
			<span class="arrow_down"></span>
		</div>

		<div id="mu_app" name="mu_app" class="lmenu_content">
			<ul class="lmenu_list">
				';
if (empty($this->_tpl_vars['adminmenus']['app'])) $this->_tpl_vars['adminmenus']['app'] = array();
elseif (!is_array($this->_tpl_vars['adminmenus']['app'])) $this->_tpl_vars['adminmenus']['app'] = (array)$this->_tpl_vars['adminmenus']['app'];
$this->_tpl_vars['j']=array();
$this->_tpl_vars['j']['columns'] = 1;
$this->_tpl_vars['j']['count'] = count($this->_tpl_vars['adminmenus']['app']);
$this->_tpl_vars['j']['addrows'] = count($this->_tpl_vars['adminmenus']['app']) % $this->_tpl_vars['j']['columns'] == 0 ? 0 : $this->_tpl_vars['j']['columns'] - count($this->_tpl_vars['adminmenus']['app']) % $this->_tpl_vars['j']['columns'];
$this->_tpl_vars['j']['loops'] = $this->_tpl_vars['j']['count'] + $this->_tpl_vars['j']['addrows'];
reset($this->_tpl_vars['adminmenus']['app']);
for($this->_tpl_vars['j']['index'] = 0; $this->_tpl_vars['j']['index'] < $this->_tpl_vars['j']['loops']; $this->_tpl_vars['j']['index']++){
	$this->_tpl_vars['j']['order'] = $this->_tpl_vars['j']['index'] + 1;
	$this->_tpl_vars['j']['row'] = ceil($this->_tpl_vars['j']['order'] / $this->_tpl_vars['j']['columns']);
	$this->_tpl_vars['j']['column'] = $this->_tpl_vars['j']['order'] % $this->_tpl_vars['j']['columns'];
	if($this->_tpl_vars['j']['column'] == 0) $this->_tpl_vars['j']['column'] = $this->_tpl_vars['j']['columns'];
	if($this->_tpl_vars['j']['index'] < $this->_tpl_vars['j']['count']){
		list($this->_tpl_vars['j']['key'], $this->_tpl_vars['j']['value']) = each($this->_tpl_vars['adminmenus']['app']);
		$this->_tpl_vars['j']['append'] = 0;
	}else{
		$this->_tpl_vars['j']['key'] = '';
		$this->_tpl_vars['j']['value'] = '';
	...
	echo '
				';
if($this->_tpl_vars['adminmenus']['app'][$this->_tpl_vars['j']['key']]['publish'] == 1){
echo '
				<li><a href="'.$this->_tpl_vars['adminmenus']['app'][$this->_tpl_vars['j']['key']]['command'].'" target="mainframe">'.$this->_tpl_vars['adminmenus']['app'][$this->_tpl_vars['j']['key']]['caption'].'</a></li>
				';
}
echo '
				';
