...
echo '/'.$this->_tpl_vars['blockfiles'][$this->_tpl_vars['i']['key']]['filename'].'.php</td>
    <td align="center"><a href="'.$this->_tpl_vars['jieqi_url'].'/admin/blockfiles.php?action=blocks&module='.urlencode($this->_tpl_vars['blockfiles'][$this->_tpl_vars['i']['key']]['module']).'&filename='.urlencode($this->_tpl_vars['blockfiles'][$this->_tpl_vars['i']['key']]['filename']).'">管理区块参数</a></td>
  </tr>
';
}
echo '
