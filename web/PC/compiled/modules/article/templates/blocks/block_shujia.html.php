...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
<dd class="fix"><em class="nam"><a href="'.$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['url_articleinfo'].'" target="_blank" class="f_black">¡¶'.$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['articlename'].'¡·</a></em><em class="nam2"><a href="'.$this->_tpl_vars['bookcaserows'][$this->_tpl_vars['i']['key']]['url_lastchapter'].'" target="_blank" class="f_blue1">¿ªÊ¼ÔÄ¶Á</a></em>
