...
INSERT INTO `jieqi_system_modules` (`mid`, `name`, `caption`, `description`, `version`, `vtype`, `lastupdate`, `weight`, `publish`, `modtype`) VALUES (0, 'news', '新闻发布', '与本站结合的新闻发布', 230, '', 0, 0, 1, 0);
