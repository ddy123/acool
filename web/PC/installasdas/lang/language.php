...
$jieqiLang['install']['step0_summary'] = '安装方式分两种：1、全新安装；2、模块安装。<br /><br />';
$jieqiLang['install']['step0_content'] = '<b>－欢迎使用杰奇网站管理系统(JIEQI CMS)－</b><br /><br />安装前先把系统框架和您需要的模块程序传到网站根目录下。<br /><br />如果系统已经存在，需要安装新的模块，则上传本模块目录下文件即可。<br /><br />例如：要安装小说连载模块（article），正确的文件存放目录结构如下：<br /><br />/files/article/*.*<br />/configs/article/*.*<br />/modules/article/*.*<br />/install/sql/article/*.*';
$jieqiLang['install']['step1_title'] = '选择安装语言';
$jieqiLang['install']['step1_summary'] = '选择当前安装程序使用的默认语言，必须与程序设计语言匹配，默认为 gbk<br /><br />';
...
$jieqiLang['install']['sys_php_version_suggest'] = '5.3.x';
...
$jieqiLang['install']['sys_server_software_suggest'] = 'Apache/IIS/Nginx';
...
$jieqiLang['install']['step5_0_title'] = '配置网站URL地址';
$jieqiLang['install']['step5_0_summary'] = '通常是您网站的域名，例如：http://www.jieqi.com，注意末尾不要“/”。<br />此处也可以留空，网页内链接使用相对路径。';
