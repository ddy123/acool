...
function addCookie() {
    try {
        window.external.AddFavorite('http://127.0.0.1', '原创小说')
    } catch(e) { (window.sidebar) ? window.sidebar.addPanel('原创小说。127.0.0.1', 'http://127.0.0.1', '') : alert('请使用按键 Ctrl+d，原创小说')
    }
}
function login(){
if (jieqiUserInfo['jieqiUserId'] > 0) {
document.writeln("<div class=\"m_top\">");
document.writeln("<div class=\"main\">");
document.writeln("<div class=\"fl\">");
document.writeln("&nbsp;<strong><i class=\"fa fa-user fa-fw\"></i>" + jieqiUserInfo['jieqiUserName_un'] + "</strong> ┊ <a href=\"/message.php?box=inbox\"><i class=\"fa fa-comment fa-fw \"></i>&nbsp;短消息</a> ┊ <a href=\"/modules/article/bookcase.php\"><i class=\"fa fa-align-left fa-fw \"></i>&nbsp;我的书架</a> ┊ <a href=\"/userdetail.php\"><i class=\"fa fa-user-plus fa-fw \"></i>&nbsp;个人中心</a> ┊ <a href=\"/modules/pay/buyegold.php\"><i class=\"fa fa-paypal fa-fw \"></i>&nbsp;帐户充值</a> ┊ <a href=\"/logout.php\"><i class=\"fa fa-circle-o-notch fa-fw \"></i>&nbsp;退出</a>");
document.writeln("</div>");
document.writeln("<div class=\"fr\"><a href=\"/index.php?charset=gbk\"><i class=\"fa fa-bookmark-o fa-fw \"></i>&nbsp;简体版</a>&nbsp;<a href=\"/index.php?charset=big5\"><i class=\"fa fa-bookmark fa-fw \"></i>&nbsp;繁体版</a>&nbsp;&nbsp;</div>");
document.writeln("</div>");
document.writeln("</div>");
} else {
    var jumpurl = "";
...
document.writeln("<div class=\"main\">");
document.writeln("<div class=\"fl\">");
document.writeln("<form name=\"t_frmlogin\" id=\"t_frmlogin\" method=\"post\" action=\"/login.php\">");
document.writeln("&nbsp;用户名：<input type=\"text\" class=\"text\" size=\"10\" maxlength=\"30\" style=\"width:70px;\" name=\"username\" onKeyPress=\"javascript: if (event.keyCode==32) return false;\">");
document.writeln("密码：<input type=\"password\" class=\"text\" size=\"10\" maxlength=\"30\" style=\"width:70px;\" name=\"password\">");
document.writeln("验证码：<input type=\"text\" class=\"text\" size=\"4\" maxlength=\"8\" style=\"width:35px;\" name=\"checkcode\" onfocus=\"if($_(\'t_imgccode\').style.display == \'none\'){$_(\'t_imgccode\').src = \'/checkcode.php\';$_(\'t_imgccode\').style.display = \'\';}\" title=\"点击显示验证码\"><img id=\"t_imgccode\" src=\"\" style=\"cursor:pointer;vertical-align:middle;margin-left:3px;display:none;\" onclick=\"this.src=\'/checkcode.php?rand=\'+Math.random();\" title=\"点击刷新验证码\">");
document.writeln("<input type=\"checkbox\" class=\"checkbox\" name=\"usecookie\" value=\"1\" />自动登录");
document.writeln("<input type=\"button\" class=\"button\" value=\"登录\" name=\"t_btnlogin\" id=\"t_btnlogin\" onclick=\"Ajax.Tip(event, \'t_frmlogin\', {timeout:3000, onLoading:\'登录中...\', onComplete:\'登录成功，页面跳转中...\'});\">");
document.writeln("<input type=\"hidden\" name=\"action\" value=\"login\">");
document.writeln("<input type=\"hidden\" name=\"jumpreferer\" value=\"1\">");
document.writeln("<a href=\"/api/qq/login.php\" rel=\"nofollow\" target=\"_top\"><i class=\"fa fa-qq fa-fw \"></i></a>");
document.writeln("<a href=\"/api/weibo/login.php\" rel=\"nofollow\" target=\"_top\"><i class=\"fa fa-weibo fa-fw \"></i></a>");
document.writeln("&nbsp;&nbsp;<a class=\"hottext\" href=\"/register.php\" onclick=\"openDialog(\'/register.php?ajax_gets=jieqi_contents\', false);stopEvent();\"><i class=\"fa fa-cog fa-fw \"></i>&nbsp;注册用户</a>&nbsp;&nbsp; <a class=\"hottext\" href=\"/getpass.php\" onclick=\"openDialog(\'/getpass.php?ajax_gets=jieqi_contents\', false);stopEvent();\"><i class=\"fa fa-key fa-fw \"></i>&nbsp;忘记密码？</a>");
