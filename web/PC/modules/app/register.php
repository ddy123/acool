...
if($result)
{
	...
	else//可以注册
	{
		...
		$sql = 'INSERT INTO `' . jieqi_dbprefix('system_users'). "` (`uname`,`name`,`pass`,`groupid`,`regdate`,`setting`,`sex`,`faceImg`,`mobile`) VALUES ('" . $userName . "', '" . $name . "', '" . $password . "', '" . $groupID . "', '" . $redate . "', '" . $setting .  "', '" . $sex . "', '" . $faceImg . "', '" . $phoneNum . "')";
