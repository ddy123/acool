...
if (isset($_REQUEST['action']) && !empty($_REQUEST['id'])) {
    ...
    case 'quxiao':
		$article_handler->updatefields(array('monthly' => 0,'isvip' => 1), $criteria);
		$obook_handler->updatefields(array('canbesp' => 0), $criteria);
		break;	
...
$jieqiTset['jieqi_contents_template'] = $jieqiModules['article']['path'] . '/templates/admin/articlelistbaoyue.html';
...
$criteria->add(new Criteria('monthly', 1, '='));
