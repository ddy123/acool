...
echo "\n\t<bookstatus><![CDATA[{$info['fullflag']}]]></bookstatus>";
echo "\n\t<keywords><![CDATA[" . str_replace(' ', ',', trim($info['keywords'])) . "]]></keywords>";
echo "\n\t<coverpath><![CDATA[" . (empty($info['imgflag']) ? 'http://www.mianfeidushu.com/modules/article/images/nocover.jpg' : 'http://img.mianfeidushu.com/image/' . floor($id / 1000) . '/' . $id . '/' . $id . 's.jpg') . "]]></coverpath>";
