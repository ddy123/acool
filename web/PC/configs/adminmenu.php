...
$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '动作参数设置', 'command'=>JIEQI_URL.'/admin/action.php?mod=system', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '小说分类设置', 'command'=>JIEQI_URL.'/admin/category.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '充值记录', 'command'=>$GLOBALS['jieqiModules']['pay']['url'].'/admin/paylog.php', 'target' => 0, 'publish' => 1);

//$jieqiAdminmenu['system'][] = array('layer' => 0, 'caption' => '生成静态首页', 'command'=>JIEQI_URL.'/indexs.php', 'target' => 0, 'publish' => 1);

//==========================================================
//用户管理导航
//==========================================================
$jieqiAdminmenu['users'][] = array('layer' => 0, 'caption' => '用户组管理', 'command'=>JIEQI_URL.'/admin/groups.php', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['users'][] = array('layer' => 0, 'caption' => '头衔管理', 'command'=>JIEQI_URL.'/admin/honors.php', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['users'][] = array('layer' => 0, 'caption' => 'VIP组管理', 'command'=>JIEQI_URL.'/admin/vips.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['test'][] = array('layer' => 0, 'caption' => '系统收件箱', 'command'=>JIEQI_URL.'/admin/message.php?box=inbox', 'target' => 0, 'publish' => 1);
