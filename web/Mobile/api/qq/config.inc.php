...
$apiConfigs[$apiName]['appid'] = '101368667';  //应用ID，根据实际申请的值修改

$apiConfigs[$apiName]['appkey'] = 'e56a56aaaf7250493a0c475bb3fe9730';  //接口密钥，根据实际申请的值修改

$apiConfigs[$apiName]['callback'] = JIEQI_LOCAL_URL.'/api/'.$apiName.'/loginback.php';  //登录后返回的本站地址，请勿修改  JIEQI_LOCAL_URL.'/api/'.$apiName.'/loginback.php'
