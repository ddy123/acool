...
<td align="center">'.$this->_tpl_vars['obookrows'][$this->_tpl_vars['i']['key']]['sumhurry'].'</td>
    ...
    <td align="center"><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/articlemanage.php?id='.$this->_tpl_vars['obookrows'][$this->_tpl_vars['i']['key']]['articleid'].'" target="_blank">管理</a> | 
	<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/articleedit.php?id='.$this->_tpl_vars['obookrows'][$this->_tpl_vars['i']['key']]['articleid'].'" target="_blank">编辑</a> | <a href="'.jieqi_geturl('article','article',$this->_tpl_vars['obookrows'][$this->_tpl_vars['i']['key']]['articleid'],'index').'" target="_blank">目录</a></td>
  </tr>
  ';
}
echo '
