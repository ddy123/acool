...
<div class="container">
	<div class="mod block form">
		<div class="hd">
			<h4>《'.$this->_tpl_vars['obookname'].'》章节销售统计</h4>
</div>
<div class="bd">
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr>
    ...
    <td align="center"><a href="'.$this->_tpl_vars['obook_dynamic_url'].'/chapterbuylog.php?cid='.$this->_tpl_vars['ochapterrows'][$this->_tpl_vars['i']['key']]['ochapterid'].'&oid='.$this->_tpl_vars['obookid'].'">详细</a></td>
  </tr>
';
}
echo '
