...
<div>
	...
	<div style="text-align:center;padding:20px">
		<a class="btnlink" href="'.$this->_tpl_vars['jieqi_url'].'/userdetail.php">查看我帐户</a> &nbsp;&nbsp;&nbsp;&nbsp; 
...
<table class="grid" width="100%" align="center">
  ...
  <tr>
	...
	<ul class="recnTul">
	  <li onclick="check_radio();"><input type="radio" name="egold" value="1000" class="radio" checked="checked"> 1000 '.$this->_tpl_vars['egoldname'].'<span>10元</span></li>
	  <li onclick="check_radio();"><input type="radio" name="egold" value="2000" class="radio"> 2000 '.$this->_tpl_vars['egoldname'].'<span>20元</span></li>
...
<div class="textbox">
<strong>说明：</strong><br />
1、网上银行充值，兑换比例：<span class="hot">1</span>元=<span class="hot">100</span>'.$this->_tpl_vars['egoldname'].'<br />
