...
<div class="phone-name"> 
          <h3>作品书名：</h3>
		  <input type="text" class="text" name="articlename" id="articlename" size="30" maxlength="20" value="'.$this->_tpl_vars['articlevals']['articlename'].'" />
         </div>
<div class="phone-name"> 
          <h3>副标题（可不填）：</h3>
		  <input type="text" class="text" name="backupname" id="backupname" size="30" maxlength="20" value="'.$this->_tpl_vars['articlevals']['backupname'].'" />
         </div>
<div class="phone-name"> 
          <h3>关键字：</h3>
