...
echo ' 
	  ...
	  <div class="mod mod-back breadcrumb">
				<div class="bd">
					...
					<a href="'.$this->_tpl_vars['url_articleinfo'].'">'.$this->_tpl_vars['article_title'].'</a>
					<span class="divide"></span>
					<a href="'.$this->_tpl_vars['url_index'].'">章节目录</a>
				</div>
			</div>
			<h1 class="page-title">'.$this->_tpl_vars['jieqi_title'].'</h1>
...
<p>'.$this->_tpl_vars['jieqi_content'].'</p>
			...
			<div class="mod page-control">
				<div class="bd">
					<a href="'.$this->_tpl_vars['url_previous'].'" class="prev"><span><</span>上一章</a>
			...
			<ul>
			<li><a href="javascript:;"  onclick="GPage.addbook(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/addbookcase.php?bid='.$this->_tpl_vars['articleid'].'&cid='.$this->_tpl_vars['chapterid'].'\',\'addbook\');" id="addbook" ><i></i><span id="favtext">书签</span></a></li>
			<li><a href="'.$this->_tpl_vars['jieqi_url'].'/modules/article/addreward.php?id='.$this->_tpl_vars['articleid'].'"><i class="reward"></i>打赏</a></li>
			<li><a href="'.$this->_tpl_vars['url_articleinfo'].'"><i class="reply"></i>评论</a></li>
			</ul>
			<div class="clear"></div>
...
<table border="0" width="100%" cellpadding="2" cellspacing="1">
            <tr>
                <td align="center" style="padding-bottom: 6px;"><font color=red>关注微信公众号: mianfeidushuvip ，方便下次阅读</font>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <img src="/sink/image/weixin.jpg" width="200" height="200" title="" />
                </td>
            </tr>
            <tr>
                <td align="center" style="padding-top: 6px;"><font color=red>微信内可长按扫码识别</font>
                </td>
            </tr>
        </table>
...
<script>
$.get("/modules/article/articlevisit.php", {id:'.$this->_tpl_vars['article_id'].',number:1} );
</script>
</body></html>
';
?>