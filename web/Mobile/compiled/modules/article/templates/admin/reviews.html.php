<?php
echo '<form name="frmsearch" method="get" action="'.$this->_tpl_vars['article_dynamic_url'].'/'.$this->_tpl_vars['articlepath'].'/reviews.php">
<table class="grid" width="100%" align="center">
    <tr>
      <td>
	  <span class="fr">[<a href="'.$this->_tpl_vars['article_dynamic_url'].'/'.$this->_tpl_vars['articlepath'].'/reviews.php?type=all">全部书评</a>] &nbsp;&nbsp; [<a href="'.$this->_tpl_vars['article_dynamic_url'].'/'.$this->_tpl_vars['articlepath'].'/reviews.php?type=good">精华书评</a>]&nbsp;</span>
        关键字：
...
<form name="frmsearch" method="get" action="'.$this->_tpl_vars['article_dynamic_url'].'/'.$this->_tpl_vars['articlepath'].'/reviews.php">
<table class="grid" width="100%" align="center">
  <tr align="center">
...
echo '<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/reviewshow.php?tid='.$this->_tpl_vars['reviewrows'][$this->_tpl_vars['i']['key']]['topicid'].'" target="_blank">'.$this->_tpl_vars['reviewrows'][$this->_tpl_vars['i']['key']]['title'].'</a></td>
	...
	<td align="center"><a id="act_delete_'.$this->_tpl_vars['reviewrows'][$this->_tpl_vars['i']['key']]['topicid'].'" href="javascript:;" onclick="if(confirm(\'确实要删除该书评么？\')) Ajax.Tip(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/reviews.php?tid='.$this->_tpl_vars['reviewrows'][$this->_tpl_vars['i']['key']]['topicid'].'&act=delete'.$this->_tpl_vars['jieqi_token_url'].'\', {method: \'POST\'});">删除</a></td>
  </tr>
  ';
}
echo '
