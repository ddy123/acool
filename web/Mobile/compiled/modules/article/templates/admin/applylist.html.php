...
<div class="gridtop">作者申请记录&nbsp;&nbsp;&nbsp; <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/applylist.php">全部记录</a> | <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/applylist.php?display=ready">待审记录</a> | <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/applylist.php?display=success">已审记录</a> | <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/applylist.php?display=failure">被拒记录</a></div>
<form id="form1" name="form1" method="post" action="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/applylist.php" onSubmit="javascript:if(confirm(\'确实要删除选中记录么？\')) return true; else return false;">
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr>
	...
	<td align="center"><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/applyinfo.php?id='.$this->_tpl_vars['applyrows'][$this->_tpl_vars['i']['key']]['applyid'].'" target="_blank">点击查看</a></td>
    <td>';
...
echo '</td>
	...
	<td align="center"><a href="'.$this->_tpl_vars['jieqi_url'].'/'.$this->_tpl_vars['adminpath'].'/usermanage.php?id='.$this->_tpl_vars['applyrows'][$this->_tpl_vars['i']['key']]['applyuid'].'" target="_blank">管理会员</a> | <a href="'.$this->_tpl_vars['jieqi_url'].'/'.$this->_tpl_vars['adminpath'].'/personmanage.php?id='.$this->_tpl_vars['applyrows'][$this->_tpl_vars['i']['key']]['applyuid'].'" target="_blank">联系方式</a> | <a href="'.$this->_tpl_vars['jieqi_url'].'/'.$this->_tpl_vars['adminpath'].'/newmessage.php?receiver='.$this->_tpl_vars['applyrows'][$this->_tpl_vars['i']['key']]['applyname'].'" target="_blank">短信回复</a></td> 
    <td align="center">
	';
...
echo '
	<a id="act_delete_'.$this->_tpl_vars['applyrows'][$this->_tpl_vars['i']['key']]['applyid'].'" href="javascript:;" onclick="act_delete(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/applylist.php?id='.$this->_tpl_vars['applyrows'][$this->_tpl_vars['i']['key']]['applyid'].'&act=delete'.$this->_tpl_vars['jieqi_token_url'].'\');">删除</a></td>
  </tr>
  ';
}
echo '
