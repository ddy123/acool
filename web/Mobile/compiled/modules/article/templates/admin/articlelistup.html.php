...
echo '</td>
<td>';
if($this->_tpl_vars['monthlyrows'][$this->_tpl_vars['i']['key']]['types'] ==1){
echo '签约';
}elseif($this->_tpl_vars['monthlyrows'][$this->_tpl_vars['i']['key']]['types'] == 2){
echo '上架';
}
echo '</td>
    <td><a href="'.$this->_tpl_vars['jieqi_url'].'/modules/article/'.$this->_tpl_vars['articlepath'].'/articleups.php?id='.$this->_tpl_vars['monthlyrows'][$this->_tpl_vars['i']['key']]['id'].'">管理</a></td>
  </tr>
  ';
}
echo '
