...
<form name="frmsearch" method="get" action="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php">
...
echo '>发表者 
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;[<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php">显示全部</a> | <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php?type=1">普通草稿</a> | <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php?type=2">定时章节</a> | <a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php?type=3">待审章节</a>]  
        </td>
    </tr>
</table>
</form>
...
<form action="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php" method="post" name="checkform" id="checkform">
<table class="grid" width="100%" align="center">
  <caption>';
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr valign="middle">
    ...
    <td><a href="'.$this->_tpl_vars['article_static_url'].'/'.$this->_tpl_vars['articlepath'].'/draftshow.php?id='.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['draftid'].'" target="_blank">'.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['chaptername'].'</a></td>
...
echo '</td>
	<td align="center"><a href="'.jieqi_geturl('system','user',$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['posterid'],'info').'" target="_blank">'.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['poster'].'</a> [<a href="'.$this->_tpl_vars['jieqi_url'].'/'.$this->_tpl_vars['adminpath'].'/newmessage.php?receiver='.urlencode($this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['poster']).'&title=" target="_blank">发消息</a>]</td>
    <td align="center">
	<a href="'.$this->_tpl_vars['article_static_url'].'/'.$this->_tpl_vars['articlepath'].'/draftshow.php?id='.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['draftid'].'" target="_blank">查看</a> 
	<a href="'.$this->_tpl_vars['article_static_url'].'/'.$this->_tpl_vars['articlepath'].'/draftedit.php?id='.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['draftid'].'" target="_blank">编辑</a> 
	<a id="act_delete_'.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['draftid'].'" href="javascript:;" onclick="act_delete(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php?checkid='.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['draftid'].'&type='.$this->_tpl_vars['_request']['type'].'&act=delete'.$this->_tpl_vars['jieqi_token_url'].'\');">删除</a>
	';
if($this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['display_n'] == 1){
echo ' <a id="act_audit_'.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['draftid'].'" href="javascript:;" onclick="Ajax.Tip(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/'.$this->_tpl_vars['articlepath'].'/draftlist.php?checkid='.$this->_tpl_vars['draftrows'][$this->_tpl_vars['i']['key']]['draftid'].'&type='.$this->_tpl_vars['_request']['type'].'&act=audit'.$this->_tpl_vars['jieqi_token_url'].'\', {method: \'POST\'});">审核</a>';
}
echo '</td>
';
}
