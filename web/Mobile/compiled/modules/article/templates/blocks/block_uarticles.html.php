...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr>
    ...
    <td align="center"><a id="ua_addbookcase_'.$this->_tpl_vars['articlerows'][$this->_tpl_vars['i']['key']]['articleid'].'" href="javascript:;" onclick="Ajax.Tip(\''.$this->_tpl_vars['jieqi_modules']['article']['url'].'/addbookcase.php?bid='.$this->_tpl_vars['articlerows'][$this->_tpl_vars['i']['key']]['articleid'].'\', {method: \'POST\'});">收藏</a></td>
  </tr>
';
}
echo '  
