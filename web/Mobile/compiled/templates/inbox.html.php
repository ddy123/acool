...
echo '
<style>
#pagelink{margin-top: -16px;}
</style>
<div class="mod block comments reply-list">
				<div class="hd">
					<h4>Ьсаб</h4>
				</div>
				<div class="bd">
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
						<li><span class="count">'.$this->_tpl_vars['i']['order'].'</span><!--a href="'.$this->_tpl_vars['jieqi_url'].'/messagedetail.php?id='.$this->_tpl_vars['messagerows'][$this->_tpl_vars['i']['key']]['messageid'].'"-->'.$this->_tpl_vars['messagerows'][$this->_tpl_vars['i']['key']]['title'].'<!--/a--></li>
					';
}
echo '
						</ul>
