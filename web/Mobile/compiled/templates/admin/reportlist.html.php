<?php
echo '<form name="frmreportlist" method="post" action="'.$this->_tpl_vars['jieqi_url'].'/admin/reportlist.php">
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr>
    ...
    <td valign="top"><a href="reportdetail.php?id='.$this->_tpl_vars['reportrows'][$this->_tpl_vars['i']['key']]['reportid'].'">'.$this->_tpl_vars['reportrows'][$this->_tpl_vars['i']['key']]['reporttitle'].'</a>
	</td>
...
echo '</td>
    <td valign="top" align="center"><a href="javascript:if(confirm(\'确实要删除该报告么？\')) document.location=\'reportlist.php?checkaction=1&checkid[]='.$this->_tpl_vars['reportrows'][$this->_tpl_vars['i']['key']]['reportid'].'\';">删除</a></td>
  </tr>
';
}
echo '
