...
<tr><td id="frametop">
	<div id="admintop">
		<div id="top_logo"><h1>'.$this->_tpl_vars['jieqi_sitename'].'</h1></div>
		<div id="top_nav">
		<ul id="admin_menu">
...
echo '
		...
		<div id="top_link">
			'.$this->_tpl_vars['jieqi_version'].' '.$this->_tpl_vars['jieqi_vtype'].' - '.$this->_tpl_vars['username'].' <a href="'.$this->_tpl_vars['jieqi_url'].'/logout.php" target="_top">[退出]</a>
		</div>
