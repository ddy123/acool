...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
  ...
  <tr>
    ...
    <td align="center"><a href="'.$this->_tpl_vars['jieqi_url'].'/admin/groups.php?id='.$this->_tpl_vars['groups'][$this->_tpl_vars['i']['key']]['groupid'].'&action=edit">编辑</a>';
if($this->_tpl_vars['groups'][$this->_tpl_vars['i']['key']]['grouptype'] == 0){
echo '  <a href="javascript:if(confirm(\'确实要删除该用户组么？\')) document.location=\''.$this->_tpl_vars['jieqi_url'].'/admin/groups.php?id='.$this->_tpl_vars['groups'][$this->_tpl_vars['i']['key']]['groupid'].'&action=delete\';">删除</a>';
}
echo '</td>
  </tr>
  ';
