...
echo '> 保密
			...
			<div class="ft"><input type="hidden" name="action" value="update" />'.$this->_tpl_vars['jieqi_token_input'].'<input type="submit" name="submit" value="保存设置" class="btn btn-auto btn-blue">
			</div>
		</form>
	</div>
</div>
