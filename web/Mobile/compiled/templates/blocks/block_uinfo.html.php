...
<ul class="ulcenter" style="margin:10px 0">
  ...
  <li style="width:50%;float:left;"><a id="addfriends" href="javascript:;" onclick="Ajax.Tip(event, \''.$this->_tpl_vars['jieqi_url'].'/addfriends.php?id='.$this->_tpl_vars['uid'].'\', 3000);"  class="friend">加为好友</a></li>
  ';
...
echo '
  <li style="width:50%;float:lefta href="'.jieqi_geturl('system','user',$this->_tpl_vars['uid'],'info').'"  class="userinfo">查看资料</a></li>
  ';
}
echo '
