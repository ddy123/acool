...
<table class="grid" width="600" align="center">
  <caption>
  <a href="'.$this->_tpl_vars['jieqi_url'].'/newmessage.php?receiver='.urlencode($this->_tpl_vars['name']).'&ajax_gets=jieqi_contents">发送消息</a> | <a id="addfriends" href="'.$this->_tpl_vars['jieqi_url'].'/addfriends.php?id='.$this->_tpl_vars['uid'].'&act=add'.$this->_tpl_vars['jieqi_token_url'].'">加为好友</a> | <a href="'.$this->_tpl_vars['jieqi_url'].'/ptopics.php?oid='.$this->_tpl_vars['uid'].'">会客室</a>
  </caption>
  <tr>
