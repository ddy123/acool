...
echo '
	...
	<!--
	验证码：<input type="text" class="text t_s" size="4" maxlength="8" style="width:35px;" name="checkcode" onfocus="if($_(\'t_imgccode\').style.display == \'none\'){$_(\'t_imgccode\').src = \''.$this->_tpl_vars['jieqi_url'].'/checkcode.php\';$_(\'t_imgccode\').style.display = \'\';}" title="点击显示验证码"><img id="t_imgccode" src="" style="cursor:pointer;vertical-align:middle;margin-left:3px;display:none;" onclick="this.src=\''.$this->_tpl_vars['jieqi_url'].'/checkcode.php?rand=\'+Math.random();" title="点击刷新验证码">
	-->
	...
	<!--
	<a href="'.$this->_tpl_vars['jieqi_url'].'/api/qq/login.php" rel="nofollow" target="_top"><img src="'.$this->_tpl_vars['jieqi_url'].'/images/api/qq_ico.gif" title="用QQ账号登录" style="border:0;vertical-align:middle;"></a>
	<a href="'.$this->_tpl_vars['jieqi_url'].'/api/weibo/login.php" rel="nofollow" target="_top"><img src="'.$this->_tpl_vars['jieqi_url'].'/images/api/weibo_ico.gif" title="用新浪微博账号登录" style="border:0;vertical-align:middle;"></a>
	<a href="'.$this->_tpl_vars['jieqi_url'].'/api/taobao/login.php" rel="nofollow" target="_top"><img src="'.$this->_tpl_vars['jieqi_url'].'/images/api/taobao_ico.gif" title="用淘宝账号登录" style="border:0;vertical-align:middle;"></a>
	-->
	</form>
	';
}else{
echo '
	...
	<li><a href="'.$this->_tpl_vars['jieqi_url'].'/message.php?box=inbox" class="droplink"><i class="iconfont">&#xf0138;</i>消息</a>';
if($this->_tpl_vars['jieqi_newmessage'] > 0){
echo '<sup>'.$this->_tpl_vars['jieqi_newmessage'].'</sup>';
}
echo '</li>
	<li class="dropdown"><a href="'.$this->_tpl_vars['jieqi_url'].'/userdetail.php" class="droplink"><i class="iconfont">&#xf012d;</i>会员<b></b></a>
		<ul class="droplist">
			';
...
echo '
	...
	';
if($this->_tpl_vars['jieqi_modules']['article']['publish'] > 0){
echo '<li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/bookcase.php" class="droplink"><i class="iconfont">&#xf00b1;</i>书架</a></li>';
}
echo '
	';
if($this->_tpl_vars['jieqi_modules']['pay']['publish'] > 0){
echo '<li><a href="'.$this->_tpl_vars['jieqi_modules']['pay']['url'].'/buyegold.php" class="droplink"><i class="iconfont">&#xf0029;</i>充值</a></li>';
}
echo '
	<li><a href="'.$this->_tpl_vars['jieqi_user_url'].'/logout.php" class="droplink"><i class="iconfont">&#xf017c;</i>退出</a></li>
	</ul>
	';
}
echo '
...
echo '>简体版</a> · <a href="'.$this->_tpl_vars['url_big5'].'"';
if($this->_tpl_vars['jieqi_charset'] == 'gbk'){
echo ' class="hot"';
}
echo '>繁体版</a>&nbsp;&nbsp;
...
<div class="mainnav cf">
	...
	<li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/articlefilter.php">书库</a>
		<ul>
			<li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/articlelist.php">分类阅读</a></li>
			<li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/toplist.php">排 行 榜</a></li>
		</ul>
	</li>
	<li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/group.php?id=1">频道</a>
		<ul>
			  <li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/group.php?id=1">男生频道</a></li>
              <li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/group.php?id=2">女生频道</a></li>
		</ul>
	</li>
	<li><a href="'.jieqi_geturl('article','toplist','1','allvisit').'">排行</a></li>
	<li><a href="'.jieqi_geturl('article','toplist','1','allvisit','','1').'">全本</a></li>
	<li><a href="'.$this->_tpl_vars['jieqi_modules']['forum']['url'].'/">论坛</a>
		<ul>
	...
	<li><a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/myarticle.php">作者专区</a>
		<ul>
...
<div class="footer">
	<div class="main">
	Powered by <strong><a href="http://www.jieqi.com" target="_blank">JIEQI CMS</a></strong> &copy; 2004-2014 <a href="http://www.jieqi.com" target="_blank">杰奇网络（jieqi.com）</a><br />
