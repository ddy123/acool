  ...
  <div style="margin:auto; width:350px;">
    <div class="block">
      ...
      <div class="blockcontent">
	    <div style="padding:10px;text-align:left;">错误原因：'.$this->_tpl_vars['errorinfo'].'<br />'.$this->_tpl_vars['debuginfo'].'<br />请 <a href="javascript:history.back(1)">返 回</a> 并修正</div>
	    <div style="text-align:right; line-height:2; padding-right:10px;">[<a href="javascript:window.close()">关闭本窗口</a>]</div>
	  </div>
