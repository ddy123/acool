...
echo '	  
        	<div class="logn">欢迎访问，<span class="g9">请<a href="'.jieqi_geturl('users','users','login','0').'" class="f_blue5">登录</a>或<a href="'.jieqi_geturl('users','users','register','0').'" class="f_blue5">注册</a></span><a href="'.$this->_tpl_vars['jieqi_url'].'/api/qq/login.php" class="qq f_gray3r" title="QQ登录">&nbsp;</a><a href="'.$this->_tpl_vars['jieqi_url'].'/api/weibo/login.php" class="sina f_gray3r" title="微博登录">&nbsp;</a></div>
