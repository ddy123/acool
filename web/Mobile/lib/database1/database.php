...
class JieqiObjectData extends JieqiObject
{
	...
	public function JieqiObjectData()
	{
		$this->JieqiObject();
	}
...
class JieqiQueryHandler extends JieqiObject
{
	...
	public function JieqiQueryHandler($db = '')
	{
		$this->JieqiObject();
	...
	public function getCount($criteria = NULL)
	{
		if (is_object($criteria)) {
			...
			if ($criteria->getGroupby() == '') {
				$count = $this->db->fetchRow($result)[0];
			}
			else {
	...
	public function updatefields($table, $fields, $criteria = NULL)
	{
...
class JieqiObjectHandler extends JieqiQueryHandler
{
	...
	public function JieqiObjectHandler($db = '')
	{
...
class Criteria extends CriteriaElement
{
	...
	public function Criteria($column, $value = '', $operator = '=')
	{
		$this->column = $column;
		$this->value = $value;
