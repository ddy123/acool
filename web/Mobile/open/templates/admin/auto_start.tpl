        ...
        <script>
            var Autospiderlist = '<{URL_auto m="auto/spiderlist"}>';
            var Autoarticlelist = '<{URL_auto m="auto/articlelist"}>';
            var Autochapterlist = '<{URL_auto m="auto/chapterlist"}>';
            var Autochapter = '<{URL_auto m="auto/chapter"}>';
            var Spiderlist=[];
            var Articlelist=[];
            var Chapterlist=[];
            var SpiderOrder=0;
