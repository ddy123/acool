...
class BlockArticleArticlelist extends JieqiBlock
{
	...
	public function setContent($isreturn = false)
	{
		...
		if (($this->exevars["isvip"] == 1) || ($this->exevars["isvip"] == 3) || ($this->exevars["isvip"] == 4) || ($this->exevars["isvip"] == 5)) {
...
//			}
			if ($this->exevars["isvip"] == 1) {
				...
				$sql .= " AND a.isvip = 3 AND a.monthly > 0";
			}
			else if ($this->exevars["isvip"] == 4) {
				$sql .= " AND a.isvip = 4 AND a.issign > 0";
			}
			else if ($this->exevars["isvip"] == 5) {
				$sql .= " AND a.isvip = 5 AND a.isvvip > 0";
			}
 ...
 */
			if ($this->exevars["isvip"] == 1) {
				...
				$sql .= " AND isvip = 3 AND monthly > 0";
			}
			else if ($this->exevars["isvip"] == 4) {
				$sql .= " AND isvip = 4 AND issign = 10";
			}
			else if ($this->exevars["isvip"] == 5) {
				$sql .= " AND isvip = 5 AND isvvip > 0";
			} 
			if (is_numeric($this->exevars["rgroup"]) && (0 <= $this->exevars["rgroup"])) {
				$sql .= " AND rgroup = " . intval($this->exevars["rgroup"]);
			}
