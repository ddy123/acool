...
if (!$content_used_cache) {
	...
	//burn修改，部分书籍的viptime为0，这时候需要用lastupdate时间
	if(!isset($articlevals['viptime']) || $articlevals['viptime'] == '0' || $articlevals['viptime'])
	{
		$articlevals['viptime'] = $articlevals['lastupdate'];
	}
