...
if (empty($errtext)) {
	 if (in_array($_REQUEST['rid'],array('2','3','4','5','6','7'))) {
		...
		$actions['review_title'] = sprintf($jieqiLang['article'][''.$gift_type.'_review_title'], $_SESSION['jieqiUserName'], $actions['aname'], $_REQUEST['count'] . $typename);
		$actions['review_content'] = sprintf($jieqiLang['article'][''.$gift_type.'_review_content'], $_REQUEST['pcontent'], $actions['aname'], $_REQUEST['count'] . $typename);
		$actions['message_title'] = sprintf($jieqiLang['article'][''.$gift_type.'_message_title'], $_SESSION['jieqiUserName'], $actions['aname'], $_REQUEST['count'] . $typename);
		$actions['message_content'] = sprintf($jieqiLang['article'][''.$gift_type.'_message_content'], $_SESSION['jieqiUserName'], $actions['aname'], $_REQUEST['count'] . $typename);
