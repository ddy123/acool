...
class JieqiArticle extends JieqiObjectData
{
	public function JieqiArticle()
	{
		...
		$this->initVar('masterid', JIEQI_TYPE_INT, 0, '所属编辑序号', false, 11);
		$this->initVar('master', JIEQI_TYPE_TXTBOX, '', '所属编辑', false, 30);
		...
		$this->initVar('daysize', JIEQI_TYPE_INT, 0, '日更新字节数', false, 11);
		$this->initVar('weeksize', JIEQI_TYPE_INT, 0, '周更新字节数', false, 11);
		$this->initVar('monthsize', JIEQI_TYPE_INT, 0, '月更新字节数', false, 11);
		$this->initVar('presize', JIEQI_TYPE_INT, 0, '上月更新字数', false, 11);
		...
		$this->initVar('articletype', JIEQI_TYPE_INT, 0, '小说类型', false, 1);
		...
		$this->initVar('freesize', JIEQI_TYPE_INT, 0, '免费字数', false, 11);
		...
		$this->initVar('vipsize', JIEQI_TYPE_INT, 0, 'VIP字数', false, 11);
