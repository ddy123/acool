...
$jieqiLang['article']['sync_article_noupdate']='检查完成，没有需要更新的小说！<script type="text/javascript"> setTimeout("if(navigator.userAgent.indexOf(\'Firefox\')==-1){window.opener=null;window.open(\'\',\'_self\');window.close();}else{var opened=window.open(\'about:blank\',\'_self\');opened.close();}", 10000); </script>';
...
$jieqiLang['article']['sync_allarticle_success']='恭喜您，全部小说同步完成，本次共同步小说 %s 本!<script type="text/javascript"> setTimeout("if(navigator.userAgent.indexOf(\'Firefox\')==-1){window.opener=null;window.open(\'\',\'_self\');window.close();}else{var opened=window.open(\'about:blank\',\'_self\');opened.close();}", 10000); </script>';
...
$jieqiLang['article']['sync_maybe_doing']='前一次同步可能正在进行中，请不要同时执行多个同步程序。<br /><br />如果您确认上次同步已经结束，请等待3分钟后再继续尝试同步！<script type="text/javascript"> setTimeout("if(navigator.userAgent.indexOf(\'Firefox\')==-1){window.opener=null;window.open(\'\',\'_self\');window.close();}else{var opened=window.open(\'about:blank\',\'_self\');opened.close();}", 10000); </script>';
