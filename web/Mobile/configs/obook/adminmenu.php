...
$jieqiAdminmenu['obook'][] = array('layer' => 0, 'caption' => '打赏记录', 'command'=>$GLOBALS['jieqiModules']['article']['url'].'/admin/actlog.php?act=', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['obook'][] = array('layer' => 0, 'caption' => '销售报表', 'command'=>$GLOBALS['jieqiModules']['obook']['url'].'/admin/saleform.php', 'target' => 0, 'publish' => 1);
?>