...
$jieqiPayset['alipay']['payreturn']='http://www.mianfeidushu.com/modules/pay/alipayreturn.php';  //接收返回的地址 (www.domain.com 是指你的网址)
...
$jieqiPayset['alipay']['show_url']='http://www.mianfeidushu.com';  //商品相关网站公司
$jieqiPayset['alipay']['seller_email']='2308810010@qq.com';  //卖家邮箱，必填
$jieqiPayset['alipay']['sign_type']='MD5';  //签名方式

$jieqiPayset['alipay']['notify_url']='http://www.mianfeidushu.com/modules/pay/alipayreturn.php'; //异步返回信息
