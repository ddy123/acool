...
class JieqiBlocksHandler extends JieqiObjectHandler
{
	...
	public function JieqiBlocksHandler($db = "")
	{
		...
		$this->sideary = array(JIEQI_SIDEBLOCK_CUSTOM => "自定义", JIEQI_SIDEBLOCK_LEFT => "左边", JIEQI_SIDEBLOCK_RIGHT => "右边", JIEQI_CENTERBLOCK_LEFT => "中左", JIEQI_CENTERBLOCK_RIGHT => "中右", JIEQI_CENTERBLOCK_TOP => "中上", JIEQI_CENTERBLOCK_MIDDLE => "中中", JIEQI_CENTERBLOCK_BOTTOM => "中下", JIEQI_TOPBLOCK_ALL => "顶部", JIEQI_BOTTOMBLOCK_ALL => "底部");
