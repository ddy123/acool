...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Template/mobile/default/Static/css/readVipChapter.css">
    <link rel="stylesheet" type="text/css" href="/Template/mobile/default/Static/css/showBuyInfo.css">
...
<body class="chapter" data-con="read_cont">
    ...
    <div id="page">
                ...
                <div>
                    ...
                    <div class="read_instr">
                        <diV class="read_info">
                            ...
                            <div class="red_info_right" style="float: left;text-align: left;margin-top: 0px;">
        ...
        <div class="tip">--- VIP章节需要购买后阅读 ---</div>
        <div class="bugchapter md-trigger" data-modal="modal-3">订阅购买</div>

        <script type="text/javascript" src="/Template/mobile/default/Static/js/wapmfds/spin.min.js"></script>
        <script type="text/javascript" src="/Template/mobile/default/Static/js/wapmfds/showBuyInfo.js"></script>
        <script type="text/javascript" src="/Template/mobile/default/Static/js/wapmfds/classie.js"></script>
        <script>
            // this is important for IEs
            var polyfilter_scriptpath = '//Template/mobile/default/Static/js/wapmfds/';
        </script>
    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function init(){
                ...
                $(".bugchapter").on("click", function() {
                    showBuyInfo(<?php echo ($chapter['articleid']); ?>,<?php echo ($chapter['chapterid']); ?>);
                });
