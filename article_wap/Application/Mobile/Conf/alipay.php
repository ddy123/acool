...
$jieqiPayset['alipay']['payid']          = '2088821972302501';  //合作伙伴ID

$jieqiPayset['alipay']['paykey']         = '2vaisb66agnzxmak3bqo4nkke5yqsn45';  //密钥值

$jieqiPayset['alipay']['payurl']         = 'https://www.alipay.com/cooperate/gateway.do';  //提交到对方的网址

$jieqiPayset['alipay']['payreturn']      ='http://m.juziread.com/User/aliPayReturn.html';  //接收返回的地址 (www.domain.com 是指你的网址)

//这个参数不设置的话，用户可以购买任意值的虚拟货币，按照一元钱100币折算。如果设置了这个参数，则购买金额只能按照里面的设置，对应的也金钱按对应关系折算，如 '1000'=>'10' 是指 1000虚拟币需要10元
$jieqiPayset['alipay']['paylimit']       = array('3000'=>'30', '8000'=>'50','13000'=>'80', '20000'=>'100', '50000'=>'200', '150000'=>'500');
...
$jieqiPayset['alipay']['show_url']       = 'http://m.juziread.com';  //商品相关网站公司
$jieqiPayset['alipay']['seller_email']   = 'beireadvip@163.com';  //卖家邮箱，必填
$jieqiPayset['alipay']['sign_type']      = 'MD5';  //签名方式

$jieqiPayset['alipay']['notify_url']     = 'http://m.juziread.com/User/aliPayReturn.php'; //异步返回信息
