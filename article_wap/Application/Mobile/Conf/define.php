...
define("URL_PREFIX",'http://www.juziread.com/modules/app/');
...
//默认书籍封面
define('DEFAULT_ARTICLE_COVER','http://www.juziread.com/modules/article/images/nocover.jpg');

//头像路径
define('DEFAULT_FACE_IMG_URL','http://img.juziread.com/facePic/');

//默认头像
define('DEFAULT_FACE_IMG','http://img.juziread.com/facePic/01.png');
...
//缓存问价路径
define('CACHE_FILE_PATH',"C:/web/PC/modules/app/cache/");
