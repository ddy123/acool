...
//         PDO::ATTR_ERRMODE           =>  PDO::ERRMODE_EXCEPTION,// 需要改为 PDO::ERRMODE_SILENT，方便用 errorInfo()方法 来获取异常信息
    	PDO::ATTR_CASE              =>  PDO::CASE_NATURAL,// 需要改为 PDO::CASE_NATURAL，表示字段名按照原始的方式显示
    	PDO::ATTR_ERRMODE           =>  PDO::ERRMODE_SILENT,// 需要改为 PDO::ERRMODE_SILENT，方便用 errorInfo()方法 来获取异常信息
